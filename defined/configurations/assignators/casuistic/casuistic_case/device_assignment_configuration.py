...
from .device_assignment_object import CasuisticDeviceAssignmentObject

class CasuisticDeviceAssignmentConfiguration(_configuration.SettingsFile[CasuisticDeviceAssignmentObject]):
